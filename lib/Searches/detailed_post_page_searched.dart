...
class detailed_searched_user extends StatefulWidget {
  final int startIndex;
  final String userId;
  detailed_searched_user({required this.startIndex,required this.userId});

  @override
  _detailed_searched_userState createState() => _detailed_searched_userState();
}

class _detailed_searched_userState extends State<detailed_searched_user> {
