...
class subs_special extends StatefulWidget {
  const subs_special({Key? key}) : super(key: key);

  @override
  State<subs_special> createState() => _subs_specialState();
}

class _subs_specialState extends State<subs_special> {
                  ...
                  Row(
                    ...
                    children: [
                                      ...
                                      Center(
                                        child: Column(
                                          children: [
                                            ...
                                            InstaImageViewer(
                                                child: Image.network(subsurls[i],
                                                  width: 500,
                                                  height: 500,)
                                            ),
                                          ],
                      ...
                      if (i + 1 < subsurls.length)
                        ElevatedButton(
                          onPressed: () {
                            Navigator.push(context, MaterialPageRoute(builder: (context) => detailed_subs_only(startIndex: i+1),));
                          },
                          style: ButtonStyle(
                            backgroundColor: MaterialStateProperty.all(Colors.black),
                          ),
